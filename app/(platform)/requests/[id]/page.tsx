...
type RequestDetail = {
  ...
  properties: { name: string; address_line_1: string } | null;
  vendor_categories: { name: string } | null;
};

type Quote = { id: string; amount_cents: number; status: string; earliest_start_at: string | null; organizations: { name: string } | null };
