...
export async function PropertyOperationsDashboard({ user, membership, mode }: { user: AppUser; membership: Membership; mode: "admin" | "manager" }) {
  const counts = await getCounts(membership.organizationId);
