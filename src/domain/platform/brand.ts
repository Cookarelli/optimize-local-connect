...
export const COMPANY_VALUES = [
  {
    name: "Local first",
    statement: "We design for the people, businesses, and relationships that make a community work.",
  },
  {
    name: "Trust is infrastructure",
    statement: "Verification, transparency, and accountability are foundations—not features.",
  },
  {
    name: "Simplicity creates access",
    statement: "The most powerful technology should also be the easiest to use.",
  },
  {
    name: "Intelligence with judgment",
    statement: "AI should clarify decisions, preserve human agency, and earn confidence through evidence.",
  },
  {
    name: "Impact must be measurable",
    statement: "We measure success in time returned, money retained locally, and stronger operating relationships.",
  },
] as const;
